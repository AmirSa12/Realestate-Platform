...
function CreateListing() {
    ...
    const {type, name, bedrooms, bathrooms, parking, furnished, address, offer, regularPrice, discountedPrice, images} = formData  // latitude , longitude deleted!
    ...
    const onSubmit = async (e) => {
        ...
        // Geo Location option should be added if it is possible
